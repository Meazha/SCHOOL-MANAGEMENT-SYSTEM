       ...
       def __init__(self, master):
              ...
              #========================================================Variables=====================================================================
               ...
               #==========================================================Functions====================================================================
                     ...
                     self.Main_Frame = LabelFrame(self.master, width = 1300, height = 500, font = ('arial',40,'bold'), \
                                                  bg = 'lightblue',bd = 15, relief = 'ridge',  text = '                     STUDENT INFORMATION ')
                     self.Main_Frame.grid(row = 0, column = 0, padx = 10, pady = 20)

                     self.Frame_1 = LabelFrame(self.Main_Frame, width = 600, height = 400, font = ('arial',25,'bold'), \
