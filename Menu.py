...
def menu():
       ...
       title_Label = Label(title_Frame, text = 'PHOENIX SCHOOL  -  MENU', font = ('arial',35,'bold'), bg = 'lightblue')
       ...
       Frame_4 = LabelFrame(root, font = ('arial',17,'bold'), width = 1000, height = 100, bg = 'lightblue', relief = 'ridge', bd = 10)
