...
class Window_1:
    def __init__(self, master):
        self.master = master
        self.master.title("PHOENIX SCHOOL Management System")
        ...
        self.Lbl_Title = Label(self.Frame, text = 'PHOENIX SCHOOL', font = ('arial',55,'bold'), bg = 'lightblue', fg = 'Black')
        self.Lbl_Title.grid(row = 0, column = 0, columnspan =3, pady = 40)
        
        self.Login_Frame_1 = LabelFrame(self.Frame, width = 1350, height = 600, relief = 'ridge', bg = 'lightblue', bd = 15,
                                        font = ('arial',20,'bold'))
        self.Login_Frame_1.grid(row = 1, column =0)
        self.Login_Frame_2 = LabelFrame(self.Frame, width = 1000, height = 600, relief = 'ridge',bg = 'lightblue', bd = 15,
                                        font = ('arial',20,'bold'))
        self.Login_Frame_2.grid(row = 2, column = 0)


        #===================================================LABEL and ENTRIES=======================================================================
        self.Label_Username = Label(self.Login_Frame_1, text = 'Username', font = ('arial',20,'bold'), bg = 'lightblue', bd = 20)
        ...
        self.Label_Password = Label(self.Login_Frame_1, text = 'Password', font = ('arial',20,'bold'), bg = 'lightblue', bd = 20)
    ...
    def Login(self):
        ...
        if (u == str('PHOENIX') and p == str('school@123')):
            self.__menu__()
        else:
...
class Window_2:
    def __init__(self, master):
        self.master = master
        self.master.title("PHOENIX SCHOOL Managment System")
        self.master.geometry('1350x750')
        self.master.config(bg="lightblue")
        self.Frame = Frame(self.master, bg="lightblue")
        self.Frame.pack()
