...
class Fee():
    def __init__(self, master):
        ...
        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='lightblue', relief='ridge', bd=8,
                             text='Informations', font=('arial', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10)

        Frame_2 = LabelFrame(Data_Frame, width=495, height=350, bg='lightblue', relief='ridge', bd=8,
        ...
        self.sem_label = Label(Frame_1, text='Class : ', font=(
            'arial', 14, 'bold'), bg='lightblue')
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', 'CBSE'),
                                         font=('arial', 14), width=19, textvariable=self.branch)
        self.branch_entry.grid(row=4, column=1, padx=15, pady=5)

        self.sem_entry = ttk.Combobox(Frame_1, values=(' ', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI', 'XII'), font=('arial', 14), width=19,
        ...
        btnCalculator = Button(Button_Frame, text='CALCULATOR', font=(
            'arial', 14, 'bold'), width=12, command=Calculator)
        btnCalculator.grid(row=0, column=7, padx=5, pady=5)
